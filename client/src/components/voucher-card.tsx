...
export function VoucherCard({ voucher, onAddExpense }: VoucherCardProps) {
  ...
  const dayCount =
    differenceInDays(new Date(voucher.endDate), new Date(voucher.startDate)) +
    1;
  ...
  // Delete voucher mutation (Supabase)
  ...
  // Delete expense mutation (Supabase)
    ...
    const htmlContent = `
      ...
      <body>
        ...
        <div class="voucher-info">
          ...
          <div class="info-section">
            <h3>Travel Period</h3>
            <p><strong>Start Date:</strong> ${format(
              new Date(voucher.startDate),
              "dd MMM yyyy"
            )}</p>
            <p><strong>End Date:</strong> ${format(
        ...
        <div className="flex items-start justify-between mb-3">
          ...
          <div className="flex items-center space-x-3">
            ...
            <Button
              variant="ghost"
              size="sm"
              className="p-1 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200"
          ...
          <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            {voucher.expenses.length > 0 ? (
              ...
              <div className="text-center py-6 text-gray-500 dark:text-gray-400">
                <ReceiptIndianRupee className="mx-auto h-8 w-8 mb-2 opacity-50" />
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              <div className="flex gap-2">
                <Button
                  variant="outline"
                  className="w-full sm:w-auto border-blue-200 text-blue-600 hover:bg-blue-50 hover:border-blue-300 dark:border-blue-800 dark:text-blue-400 dark:hover:bg-blue-900/20"
